                        ...
                        <div className="space-y-2 p-2">
                            {[...Array(6)].map((_, i) => (
                                <div key={i} className="flex items-center gap-3 p-2">
                                    <Skeleton variant="circle" className="w-10 h-10" shimmer={true} />
                                    <div className="flex-1 space-y-2">
                                        <Skeleton variant="text" width="40%" height={16} shimmer={true} />
                                        <Skeleton variant="text" width="60%" height={12} shimmer={true} />
                                    </div>
                                </div>
                            ))}
                        </div>
